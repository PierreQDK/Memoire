...
## Tests statistiques des valeurs atypiques 

```{r}
# Fonction pour détecter les points atypiques avec la méthode IQR
...
# Détecter les points atypiques dans les prix de clôture (Close) pour le maïs et le blé
corn_outliers <- detect_outliers_iqr(a1, "Close")

wheat_outliers <- detect_outliers_iqr(a1, "Close")

# Affichage des résultats des points atypiques pour CORN et WHEAT

print(corn_outliers)

print(wheat_outliers)
